...
| `skip_if_empty`                       | Skip saving to a file or leaving a comment on another repository if the content is empty                                                                                                                                                                                                                               | `file`, `issue` | String  | `""`                                                          | `file`, `issue`, `"file, issue"`                                              |
| `fail_if_skip`                        | Notify by raising an error when saving to a file or leaving a comment on another repository is skipped by `skip_if_empty` option                                                                                                                                                                                       | `file`, `issue` | Boolean | `""`                                                          | `true`                                                                        |
