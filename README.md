...
| `compression_threshold`                        | When the file size of each attached file is larger than the specified number here, it is compressed toward that size. Depending on the format and image content, it may not always become smaller than the number without additional resizing.                                                                       | `v0.4.0` | `file`, `issue` | Integer | `""`                                                          | `1048576`                                                                     |
