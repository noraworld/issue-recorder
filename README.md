...
| ~~`title_prefix`~~ **[DEPRECATED]** | ~~Specify additional letters or emojis appearing at the beginning of the title in an issue~~ Use `title_prefix_for_issue` instead                                                                                                    | ~~`issue`~~     | ~~String~~ | ~~`""`~~                                                      | ~~`✅`~~                                                                      |
