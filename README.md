...
| `with_repo_assets`                    | Specify whether the attached files that are posted on an issue are saved to a repository with cache enabled ([details](#initial-setup-for-with_repo_assets))                                                                                                                                                           | `file`, `issue` | String  | `""`                                                          | `file`, `issue`, `"file, issue"`                                              |
| `assets_repo`                         | A repository where the attached files are saved ([details](#initial-setup-for-with_repo_assets))                                                                                                                                                                                                                       | `file`, `issue` | String  | `""`                                                          | `octocat/hello-world`                                                         |
